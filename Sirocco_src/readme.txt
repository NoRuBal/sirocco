본 게임은 '제 2회 인디게임 위캔드' 행사에서 제작되었습니다.
프로그램과 그래픽, 프로그램의 소스 코드는 아래의 라이선스에 따라 자유로이 사용이 가능하십니다.

이 프로그램은 Love2d 엔진을 이용해 제작되었습니다.
http://love.org/

라이선스:
Copyright (C) 2014-2016 norubal29a@naver.com , http://blog.naver.com/norubal29a
